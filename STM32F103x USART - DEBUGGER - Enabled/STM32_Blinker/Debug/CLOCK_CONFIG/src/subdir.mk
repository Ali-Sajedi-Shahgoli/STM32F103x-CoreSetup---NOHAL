...
C_SRCS += \
../CLOCK_CONFIG/src/UART.c \
../CLOCK_CONFIG/src/rcc.c 

OBJS += \
./CLOCK_CONFIG/src/UART.o \
./CLOCK_CONFIG/src/rcc.o 

C_DEPS += \
./CLOCK_CONFIG/src/UART.d \
...
clean-CLOCK_CONFIG-2f-src:
	-$(RM) ./CLOCK_CONFIG/src/UART.cyclo ./CLOCK_CONFIG/src/UART.d ./CLOCK_CONFIG/src/UART.o ./CLOCK_CONFIG/src/UART.su ./CLOCK_CONFIG/src/rcc.cyclo ./CLOCK_CONFIG/src/rcc.d ./CLOCK_CONFIG/src/rcc.o ./CLOCK_CONFIG/src/rcc.su
